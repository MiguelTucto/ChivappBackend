...
from app.services.email.client import EmailDeliveryError, send_via_resend
...
def send_templated_email(
    ...
    *,
    ...
    try:
        ...
        error = None if provider_id else "Envío omitido (EMAIL_ENABLED o API key)"
